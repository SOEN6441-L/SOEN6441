...
import gamemodels.PlayersModel;
...
public class DominationView implements Observer{
    ...
    /**
     * This is the construter of class DominationView
     * @param newPlayers The players are in the game
     */
    public DominationView(PlayersModel newPlayers){
    ...
    class DominationChart extends JComponent {
        ...
        Slice[] slice;
        DominationChart(PlayersModel players) {
            int sliceNumber = players.getPlayers().size();
            int i = 0;
            slice = new Slice[sliceNumber];
            for (PlayerModel player:players.getPlayers()) {
